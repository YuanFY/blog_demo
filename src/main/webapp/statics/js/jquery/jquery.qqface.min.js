...
function(e) {
	...
	function() {
		...
		$.extend({
			qqface: function(n) {
				...
				u.html(o(e, n.imgPath)), r.append(u).appendTo("body"), r.on("click", "i", function() {
					var e = "[:" + $(this).data("code") + "]";
					n.before.call(null, n.textarea, e), t(n.textarea[0], e), n.after.call(null, n.textarea, e), r.hide()
				}), n.handle.on("click", function(e) {
					r.show(), i(n.handle, r), e.stopPropagation()
	...
	t = e.exports = n(3)(), t.push([e.id, ".jquery-qqface{width:406;height:163;padding:5px;border:3px solid #e5e5e5;background:#fff;display:none;position:absolute}.jquery-qqface-layer{width:375px;height:150px;cursor:pointer;position:relative}.jquery-qqface-layer i{width:26px;height:26px;border:1px solid #ccc;margin:-1px 0 0 -1px;display:block;float:left}", ""])
}, function(e, t) {
	e.exports = function() {
		var e = [];
	...
	function f(e, t) {
		...
		if (t.singleton) {
			var a = y++;
			n = x || (x = u(t)), i = c.bind(null, n, a, !1), o = c.bind(null, n, a, !0)
	...
	e.exports = function(e, t) {
		if (e.focus(), document.selection) {
			...
			var i = e.selectionStart,
				...
				a = i,
				r = e.value;
			e.value = r.substring(0, i) + t + r.substring(o, r.length), a += t.length, e.selectionStart = e.selectionEnd = a
		} else e.value += t
	}
}, function(e, t) {
	e.exports = function(e, t) {
		...
		i = r + t.outerHeight() < c ? r + s : r - t.outerHeight(), t.css({
			left: n,
			top: i
		})
	}
	...
	e.exports = function(e, t) {
		return $.map(e, function(e, n) {
			e = e.split(",");
			var i = t + e[0] + ".gif";
			return '<i data-code="' + e[0] + '"><img src="' + i + '" width="24" height="24" title="' + e[1] + '" /></i>'
		}).join("")
	}
}]);